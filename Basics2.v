...
Example test_bin_incr1:             (incr_bnat O) = (ST O).
Proof. reflexivity.  Qed.
Example test_bin_incr2:             (incr_bnat (ST O)) = (T (ST O)).
Proof. reflexivity.  Qed.
Example test_bin_incr3:             (incr_bnat (T (ST O))) = (ST (ST O)).
Proof. reflexivity.  Qed.
Example test_bin_incr4:             (incr_bnat (ST (ST O))) = (T (T (ST O))).
Proof. reflexivity.  Qed.
Example test_bin_incr5:             (incr_bnat (T (T (ST O)))) = (ST (T (ST O))).
Proof. reflexivity.  Qed.

Example test_bin2unary1:            (bin2unary O) = 0.
Proof. reflexivity.  Qed.
Example test_bin2unary2:            (bin2unary (ST O)) = 1.
Proof. reflexivity.  Qed.
Example test_bin2unary3:            (bin2unary (T (ST O))) = 2.
Proof. reflexivity.  Qed.
Example test_bin2unary4:            (bin2unary (ST (ST O))) = 3.
Proof. reflexivity.  Qed.
Example test_bin2unary5:            (bin2unary (T (T (ST O)))) = 4.
Proof. reflexivity.  Qed.
