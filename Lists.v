...
(* FILL IN HERE *)
Theorem beq_nat_eq : forall (v : nat), beq_nat v v = true.
Proof.
  intros v. induction v as [|v'].
  Case "v = 0".
    simpl. reflexivity.
  Case "v = S v'".
...
Definition hd_opt (l : natlist) : natoption := None.
